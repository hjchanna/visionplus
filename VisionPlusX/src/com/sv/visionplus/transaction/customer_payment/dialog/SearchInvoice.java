...
public class SearchInvoice extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        invoiceTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice No", "Date", "Status", "cid", "Customer Name", "Nic", "Contact No", "amount"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtNic, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(45, 45, 45)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtContactNo, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        invoiceMix.setContact_no(txtContactNo.getText());
        invoiceMix.setName(txtName.getCValue());
        invoiceMix.setNic(txtNic.getCValue());
        List<CustomerInvoiceMix> searchInvoice = SearchInvoiceDAO.getInstance().searchInvoice(invoiceMix);
        if (searchInvoice.size() == 1) {
            form.setInvoice(invoiceMix);
            this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (invoiceTable.getSelectedRowCount() == 1) {
            ...
            mix.setInvoice_no((int) invoiceTable.getValueAt(invoiceTable.getSelectedRow(), 0));
