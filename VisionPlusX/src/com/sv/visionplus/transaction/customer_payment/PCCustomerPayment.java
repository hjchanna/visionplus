...
public class PCCustomerPayment extends AbstractObjectCreator<CustomerPaymentMix> {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtInvoiceNo, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
                .addGap(12, 12, 12)
                .addComponent(jLabel4, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtNic, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtMobile, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
                .addGap(26, 26, 26)
        ...
        cardPanelLayout.setHorizontalGroup(
            ...
            .addGroup(cardPanelLayout.createSequentialGroup()
                ...
                .addGroup(cardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(cardPanelLayout.createSequentialGroup()
                        .addComponent(rdoCardPayment, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
                        .addGap(106, 106, 106))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        invoiceMix.setInvoice_no(txtInvoiceNo.getCValue());
        invoiceMix.setName(txtName.getCValue());
        invoiceMix.setNic(txtNic.getCValue());
        System.out.println(invoiceMix.getInvoice_no());
        CustomerInvoiceMix searchInvoice = SearchInvoiceDAO.getInstance().searchInvoiceById(invoiceMix.getInvoice_no());

        if (null != searchInvoice) {
            System.out.println(searchInvoice.getName());
...
//        System.out.println(searchInvoice.size());
...
//        payment.setIndexNo(0);//auto increment
        ...
        customerPayment.setInvoice(txtInvoiceNo.getCValue());
...
//            status.setIndexNo();
            status.setInvoice(txtInvoiceNo.getCValue());
        ...
        invoice.setIndexNo(txtInvoiceNo.getCValue());
...
//        accountTransaction.setIndexNo(0);//auto
    ...
    public void setInvoice(CustomerInvoiceMix searchInvoice) {
        if (searchInvoice != null) {
            ...
            txtInvoiceNo.setCValue(searchInvoice.getInvoice_no());
