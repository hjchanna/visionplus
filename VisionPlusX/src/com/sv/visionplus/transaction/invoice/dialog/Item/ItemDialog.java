...
public final class ItemDialog extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (tblItem.getSelectedRowCount() == 1) {
            ...
            if (oldValue > Double.parseDouble(txtSalesPrice.getText())) {
                mixModel.setDicsount(oldValue - Double.parseDouble(txtSalesPrice.getText()));
            }else{
            mixModel.setSale_price(Double.parseDouble(txtSalesPrice.getText()));
            }
