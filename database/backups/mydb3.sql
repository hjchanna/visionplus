...
-- Dumping data for table mydb.log_file: ~34 rows (approximately)
...
REPLACE INTO `log_file` (`index_no`, `date`, `time`, `user`, `form_name`, `transaction_type`, `value`, `remarks`) VALUES
	...
	(43, '2016-09-20', '05:55:16', 1, 'Login', 'search', 0.00, 'login User'),
	(46, '2016-09-20', '06:00:44', 1, 'Login', 'search', 0.00, 'login User'),
	(47, '2016-09-20', '06:01:42', 1, 'Invoice Form', 'Save', 200.00, 'SaveInvoice'),
	(48, '2016-09-20', '06:01:47', 1, 'Invoice Payment', 'Save', 100.00, 'Invoice Advance Payment'),
	(49, '2016-09-20', '06:34:13', 1, 'Login', 'search', 0.00, 'login User'),
	(50, '2016-09-20', '06:42:50', 1, 'Login', 'search', 0.00, 'login User'),
	(51, '2016-09-20', '08:17:20', 1, 'Login', 'search', 0.00, 'login User'),
	(52, '2016-09-20', '08:23:44', 1, 'Login', 'search', 0.00, 'login User'),
	(53, '2016-09-20', '08:26:39', 1, 'Login', 'search', 0.00, 'login User'),
	(54, '2016-09-20', '09:13:39', 1, 'Login', 'search', 0.00, 'login User'),
	(55, '2016-09-20', '09:17:49', 1, 'Login', 'search', 0.00, 'login User'),
	(56, '2016-09-20', '09:25:43', 1, 'Login', 'search', 0.00, 'login User'),
	(57, '2016-09-20', '09:31:07', 1, 'Login', 'search', 0.00, 'login User'),
	(58, '2016-09-20', '09:42:50', 1, 'Login', 'search', 0.00, 'login User');
...
-- Dumping data for table mydb.m_account: ~5 rows (approximately)
...
-- Dumping data for table mydb.status: ~11 rows (approximately)
...
-- Dumping data for table mydb.sub_category: ~6 rows (approximately)
...
-- Dumping data for table mydb.t_account_transaction: ~5 rows (approximately)
...
-- Dumping data for table mydb.t_grn: ~3 rows (approximately)
...
-- Dumping data for table mydb.t_invoice: ~4 rows (approximately)
...
REPLACE INTO `t_invoice` (`index_no`, `customer`, `factory`, `invoice_date`, `amount`, `status`, `isdelete`) VALUES
	...
	(14, 1, 1, '2016-09-20', 200.00, 'Reserved From Customer', 0);
...
-- Dumping data for table mydb.t_stock_ledger: ~7 rows (approximately)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` VIEW `search_voucher` AS select t_account_transaction.index_no,t_account_transaction.date,t_account_transaction.description,t_account_transaction.credit as amount,
main_category.name as main_category,sub_category.name as sub_category
...
and m_account.index_no=t_account_transaction.account and m_account.`type`="VOUCHER" and t_account_transaction.date=curDate() ;
